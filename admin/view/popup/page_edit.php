...
<div class="popup-inner">
    <form class="layui-form" id="pageForm" lay-filter="pageForm">
        ...
        <!-- 选项卡（em-tabs 同款，切换联动 layui-tab-content） -->
        <div class="em-tabs" id="pageEditTabs" style="margin-bottom: 0;">
...
<div class="popup-footer">
    <button type="button" class="em-btn em-reset-btn" id="pageCancelBtn"><i class="fa fa-times"></i>取消</button>
    <button type="button" class="em-btn em-save-btn" id="pageSubmitBtn"><i class="fa fa-check"></i>确认保存</button>
</div>
...
$(function () {
    ...
    // em-tabs 点击切换
    $('#pageEditTabs').on('click', '.em-tabs__item', function () {
        var $item = $(this);
    ...
    layui.use(['layer', 'form'], function () {
        ...
        // 确认保存
        $('#pageSubmitBtn').on('click', function () {
            var $btn = $(this);
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code === 200) {
                        ...
                        try { parent.window._pagePopupSaved = true; } catch (e) {}
                        var index = parent.layer.getFrameIndex(window.name);
