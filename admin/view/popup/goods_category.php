...
$rebateCatL1Pct = ($rebateCat !== null && isset($rebateCat['l1'])) ? $rebateCat['l1'] / 100 : null;
$rebateCatL2Pct = ($rebateCat !== null && isset($rebateCat['l2'])) ? $rebateCat['l2'] / 100 : null;
$rebateCatMode  = ($rebateCat !== null && !empty($rebateCat['mode'])) ? (string) $rebateCat['mode'] : '';
...
<div class="popup-inner">
    <form class="layui-form" id="catForm" lay-filter="catForm">
        ...
        <!-- 选项卡（em-tabs，和商品编辑页同款；切换联动下方 layui-tab-content 面板） -->
            ...
            <div class="layui-tab-item layui-show">
                <div class="popup-section">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" name="slug" placeholder="用于URL路径，可留空"
            ...
            <div class="layui-tab-item">
                <div class="popup-section">
                    <blockquote class="layui-elem-quote" style="margin-bottom:15px;">
                        本分类 2 级返佣比例（百分比，如 5 = 5%）。<br>
                        留空 → 使用全局级回退；填 0 → 本分类明确不返佣。
                    </blockquote>
                    <div class="layui-form-item">
                        <label class="layui-form-label">计算方式</label>
                        <div class="layui-input-block">
                            <input type="radio" name="rebate_mode" value="amount" title="按订单金额" <?php echo $rebateCatMode === 'amount' ? 'checked' : ''; ?>>
                            <input type="radio" name="rebate_mode" value="profit" title="按订单利润" <?php echo $rebateCatMode === 'profit' ? 'checked' : ''; ?>>
                            <input type="radio" name="rebate_mode" value="" title="跟随系统" <?php echo $rebateCatMode === '' ? 'checked' : ''; ?>>
                        </div>
                        ...
                        <div class="layui-input-inline" style="width:180px;">
                            <div class="layui-input-wrap">
                                <input type="number" name="rebate_l1" class="layui-input" min="0" max="100" step="0.01"
                                       placeholder="留空=未设置"
                                       value="<?php echo $rebateCatL1Pct !== null ? htmlspecialchars((string) $rebateCatL1Pct) : ''; ?>">
                        ...
                        <div class="layui-input-inline" style="width:180px;">
                            <div class="layui-input-wrap">
                                <input type="number" name="rebate_l2" class="layui-input" min="0" max="100" step="0.01"
                                       placeholder="留空=未设置"
                                       value="<?php echo $rebateCatL2Pct !== null ? htmlspecialchars((string) $rebateCatL2Pct) : ''; ?>">
                                <div class="layui-input-suffix"><i class="fa fa-percent"></i></div>
                            </div>
                        </div>
                    </div>
