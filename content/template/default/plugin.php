...
// 为下载链接添加按钮样式
function default_add_download_style($logData, &$result)
{
    // 优化正则表达式以匹配多种下载链接格式
...
addAction('article_content_echo', 'default_add_download_style');

// 定义下载按钮样式
function default_render_download_btn()
{
    echo <<<EOT
<style>
.em-download-btn {
...
addAction('index_head', 'default_render_download_btn');
